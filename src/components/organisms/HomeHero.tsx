    ...
    <section className="relative overflow-hidden bg-[linear-gradient(160deg,#f1fbf9_0%,#ffffff_55%,#e5f7f3_100%)]">
      <PageContainer className="py-6 sm:py-8 lg:py-10">
        <div className="relative overflow-hidden rounded-[1.75rem] border border-white/70 bg-[radial-gradient(120%_90%_at_12%_88%,#d9f3ee_0%,transparent_42%),linear-gradient(145deg,#f7fffd_0%,#eefaf7_48%,#f8fffe_100%)] px-5 py-8 shadow-[0_24px_60px_rgb(16_32_43/0.08)] sm:rounded-[2.25rem] sm:px-8 sm:py-10 lg:min-h-[34rem] lg:px-10 lg:py-12 xl:min-h-[36rem]">
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-8 xl:gap-12">
            {/* Copy */}
            <div className="relative z-10 max-w-xl">
              ...
              <div className="mt-7 flex flex-wrap gap-3 animate-hero-rise [animation-delay:180ms]">
                <Button
              ...
              <dl className="mt-8 grid max-w-md grid-cols-3 gap-3 animate-hero-rise [animation-delay:240ms]">
                <div>
                  <dt className="text-xl font-bold tracking-tight text-ink sm:text-2xl">
                    10K+
                  </dt>
                  <dd className="mt-0.5 text-[0.7rem] leading-snug text-ink-muted sm:text-xs">
            ...
            <div className="relative mx-auto w-full max-w-xl lg:mx-0 lg:max-w-none">
              <div className="relative mx-auto aspect-[5/4] w-full sm:aspect-[6/5] lg:aspect-[5/4] lg:min-h-[28rem]">
                ...
                <div className="pointer-events-none absolute -right-[6%] bottom-[-6%] z-[2] w-[42%] sm:w-[46%] lg:w-[48%]">
                  <Image
                ...
                <form
                  onSubmit={onSearch}
                  className="absolute left-1/2 top-[34%] z-[3] w-[min(100%,22rem)] -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-black/5 bg-white/95 p-3.5 shadow-[0_18px_50px_rgb(16_32_43/0.16)] backdrop-blur-sm sm:w-[min(100%,24rem)] sm:rounded-3xl sm:p-4 lg:left-[42%] lg:top-[42%]"
                >
                    ...
                    {tabs.map((t) => {
                      ...
                      return (
                        <button
                          ...
                          onClick={() => setTab(t.id)}
                          className={cn(
                            "flex flex-col items-center gap-1 rounded-lg px-1 py-2 text-[0.65rem] font-semibold transition sm:text-xs",
                            active
